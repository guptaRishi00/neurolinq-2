...
export default function Founder({ data }: any) {
  return (
    <div className="w-full p-6 lg:px-10 lg:py-20 mt-8 lg:mt-20 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-10 lg:gap-0">
      ...
      <div className="relative w-full lg:w-1/2 flex flex-col items-center mt-10 lg:mt-0">
        <Image
          ...
          width={500}
          height={500}
          className="lg:w-90 hidden lg:inline-block lg:h-90 absolute top-0 left-50 -translate-x-1/2 -translate-y-10 z-0"
        />
